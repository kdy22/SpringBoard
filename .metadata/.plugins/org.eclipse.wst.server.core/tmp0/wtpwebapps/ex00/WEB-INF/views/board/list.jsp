...
<%@include file="../includes/header.jsp" %>
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">KDY 게시판</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<div id="contAreaBox">
    <form id="formobj" name="inputForm" method="post" onsubmit="return _onSubmit();" action="/board/adms/reserve/applicant/create_action.do"   enctype="multipart/form-data" class="form-horizontal">
        <div class="panel">
            <div class="panel-body">
        ...
        <div class="pull-right">
            ...
            <!--  
            <a href="${path}/document/applicant_excelUpload_form.xlsx" download class="btn btn btn-primary btn-lg" >양식파일 다운로드</a>
        	-->
        </div>
    </form>
    
    <form id="excelDownload" method = "post" action="/board/excel/excelDownload">
        <button title="양식파일 다운로드" class="btn btn-primary btn-lg" type="submit" onclick="javascript:excelDownload();">양식파일 다운로드</button>
    </form>
</div>
...
<script type="text/javascript">
	var excelDownload = $("#excelDownload");
